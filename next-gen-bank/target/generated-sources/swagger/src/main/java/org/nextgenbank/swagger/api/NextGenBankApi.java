...
public class NextGenBankApi {
  private ApiClient apiClient;

  public NextGenBankApi() {
    this(Configuration.getDefaultApiClient());
  }

  public NextGenBankApi(ApiClient apiClient) {
   ...
   * @param _contentType 
   * @param activityid 
   * @param getTransactionHistoryRequest Transaction History request information
   * @param _accept 
  ...
  public GetTransactionHistoryResponse postSearch(String authorization, String _contentType, String activityid, GetTransactionHistoryRequest getTransactionHistoryRequest, String _accept, String applicationuserid, String sessionid, String interactionid, String workflowid, Date timestamp, String storeid, String terminalid, String tillid, Integer dealercode, String segmentationid, String authcustomerid, String authfinancialaccountid, String authlineofserviceid, String accessControlRequestHeaders, String accessControlRequestMethod, String ifMatch, String ifModifiedSince, String ifNoneMatch, String origin) throws ApiException {
    ...
    String path = "/getTransactionHistory".replaceAll("\\{format\\}","json");
    ...
    GenericType<GetTransactionHistoryResponse> returnType = new GenericType<GetTransactionHistoryResponse>() {};
