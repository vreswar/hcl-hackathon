...
public interface UserDAO {
	...
	List<UserTransactions> getTransactionHistory(String pAccountNumer) throws NextGenerationBankException;
	UserAccountSummary getAccountSummary(String pAccountNumber) throws NextGenerationBankException;
